...
public sealed class HawthorneAnalyzerBootstrap : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterCompilationStartAction(compilationStartContext =>
        {
            ...
            HAW106SingleLineMethodAnalyzer.Register(compilationStartContext, hawthorneConfiguration);
            ...
            HAW015DeadConfigurationAnalyzer.Register(compilationStartContext, hawthorneConfiguration);
